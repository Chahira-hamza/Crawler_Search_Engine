...
public class QueryProcessor
{
	...
	"databaseName=Indexer;user=sa;password=root"; // Declare the JDBC objects. 
	  static Connection con = null;  
	  static  String Driver="com.microsoft.sqlserver.jdbc.SQLServerDriver";
	  static 	Stemmer stemmer=new Stemmer();
	  static StopWords stopwords = null;
	  static ArrayList<String> SrchStmt=new ArrayList<String>();
	  //static ArrayList<SrchWord> aList=new ArrayList<SrchWord>();
     ...
     public static void GetDocPWord(String IN) throws SQLException
     {
