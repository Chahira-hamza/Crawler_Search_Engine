...
public class StopWords {
	...
	static String[] strArr = {"a", "about", "above", "above", "across", "after", "afterwards", "again", "against", "all",
			...
			"couldnt", "de", "describe", "detail", "do", "done","down", "due", "during", "each", "eg", "eight", "either", "eleven","else",
			 "elsewhere", "empty", "enough", "etc", "even", "ever", "every", "everyone", "everything", "everywhere", "except", "few", "fifteen",
			 "fify", "fill", "find",  "first", "five", "for", "former", "formerly", "forty", "found", "four", "from", "front", 
			...
			"in", "inc", "indeed", "interest", "into", "is", "it", "its", "itself", "keep", "last", "latter", "latterly", "i","least",
			...
			"other", "others", "otherwise", "our", "ours", "ourselves", "out", "over", "own","part", "per", "perhaps", "please", "put", 
			...
			"though", "three", "through", "throughout", "thru", "thus", "to",  "too",  "toward", "towards", "twelve",
