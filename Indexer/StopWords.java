...
public class StopWords {
	...
	static  public HashSet<String> h = new HashSet<String>();
	static String[] strArr = {"a", "about", "above", "above", "across", "after", "afterwards", "again", "against", "all",
			...
			"be","became","b" ,"because","become","becomes", "becoming", "been", "before", "beforehand", "behind", "being", "below", "beside",
			"besides", "between", "beyond", "bill", "both", "bottom","but", "by", "call", "c","can", "cannot", "cant", "co", "con", "could",
			"couldnt", "de", "d" ,"describe", "detail", "do", "done","down", "due", "during", "e","each", "eg", "eight", "either", "eleven","else",
			...
			"hereby", "herein", "hereupon", "hers", "herself", "him", "himself", "his", "how", "however", "hundred", "ie","" ,"if",
			"in", "inc", "indeed", "interest", "into", "is", "it", "its", "itself", "k","keep", "last", "latter", "latterly", "i","least",
			"less", "ltd", "l","m","made", "many", "may", "me", "meanwhile", "might", "mill", "mine", "more", "moreover", "most", "mostly",
			"move", "much", "must", "my", "myself", "name", "namely", "neither", "never", "nevertheless", "next", "nine", "no", "nobody",
			"none", "noone", "n","nor", "not", "nothing", "now", "nowhere","o" ,"of", "off", "often", "on", "once", "one", "only", "onto", "or",
			"other", "others", "otherwise", "our", "ours", "ourselves", "out", "over", "own","part","p", "per", "perhaps", "please", "put", 
			"rather", "re", "s","same", "see", "seem", "seemed", "seeming", "seems", "serious", "several", "she", "should", "show", "side",
	...
	static List<String> arrList = Arrays.asList(strArr);
	
	// Merge the HashSet and List 
	 static boolean bResultbResult =h.addAll(arrList);
}